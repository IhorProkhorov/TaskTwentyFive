...
%>
<tr>
<td><font color = "red"><%=resultSet.getString("student_id") %></td>
<td><font color = "red"><%=resultSet.getString("student_fio") %></td>
<td><font color = "red"><%=resultSet.getString("group") %></td>
<td><font color = "red"><%=resultSet.getString("year_of_start") %></td>
</tr>
<%
	}
	else{
